...
"krajina" is the ISO 3166-1 alpha-2 code of that party's address (SK, AT, IL, US, CH). Derive it from the address even when no country is printed — a city is enough (Ashdod → IL, Wien → AT, Seattle → US, Bösingen → CH). Use null only when the address says nothing about location. Keep the printed address text in "adresa" as it stands.

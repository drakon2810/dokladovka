...
A number that follows a reference phrase belongs to another document, never to this one: "conform contract", "according to contract", "to the contract", "podľa zmluvy", "k zmluve", "na základe objednávky", "Conform International Transport Order". Put such a number in orderNumber and leave invoiceNumber to the number printed as this document's own, at the "Faktúra" / "Invoice" / "Č. dokladu" label. When this document's own number is illegible, report invoiceNumber as null rather than borrowing the referenced one — a wrong number pairs the doklad with someone else's.

...
export function checkApprovable(
  ...
  if (doc.typ === 'BV') {
    ...
    // členenia DPH, lebo daňový moment nastane až pri úhrade alebo pri
    // zúčtovacej faktúre. Vyžadovať od nej účet a členenie znamenalo, že sa
    // nedala schváliť vôbec.

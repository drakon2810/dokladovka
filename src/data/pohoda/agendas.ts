...
const KV_KODY_PRE_TYP: Partial<Record<DocumentType, readonly string[]>> = {
  ...
  FP: ['B1', 'B2', 'B3', 'C2', 'KN'],
  OZ: ['B1', 'B2', 'B3', 'C2', 'KN'],
  // Bloček z e-kasy do 1 000 € je zjednodušená faktúra (§74 ods. 3): s odpočtom
  // B3, bez odpočtu KN. Plná faktúra zaplatená v hotovosti však patrí do B2 —
  // sekciu určuje druh faktúry, nie forma úhrady. Server drží zhodný zoznam
  // v kvPreDruh; B2→B3 do limitu prepisuje len návrh (kvNavrhuPreDruh).
  PD: ['B2', 'B3', 'KN'],
};
